...
def live_code_challenges():
    ...
    return render_template("live-code-challenges.html",
...
def data_types():
    ...
    return render_template("data-types.html",
                           title="Data Types")
...
def control_flow_logic():
    ...
    return render_template("control-flow-logic.html",
...
def builtin_functions():
    ...
    return render_template("builtin-functions.html",
